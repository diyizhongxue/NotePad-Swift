...
class MyPostViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func getNewData(){
        ...
        query.findObjectsInBackgroundWithBlock({ (arr:[AnyObject]!, error:NSError!) -> Void in
            ...
            self.myDataArray.addObjectsFromArray(array as [AnyObject])
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.model = self.myDataArray[indexPath.row] as! OneModel
        //cell点击不变色
    ...
    func tableView(tableView: UITableView, heightForRowAtIndexPath indexPath: NSIndexPath) -> CGFloat {
        ...
        let model = self.myDataArray[indexPath.row] as! OneModel
